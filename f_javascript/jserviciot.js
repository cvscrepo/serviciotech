...
function ingresar_datos_servicio_3(){
 ...
 if ( ($("#fech").val()=='' || $("#fech").val()==null ) || ($("#falla").val()=='' || $("#falla").val()==null ) || 
 ($("#come").val()=='' || $("#come").val()==null ) || //($("#terminado1").val()=='' || $("#terminado1").val()==null ) ||
 ($("#idsol").val()=='' || $("#idsol").val()==null ) //|| ($("#cotizar").val()=='' || $("#cotizar").val()==null ) 
...
function ver_tabla(){
  ...
  $("#tabla_reporte").load("../epages/select_pages/frm_con_serviciot.php",function(){
   $(this).fadeIn("medium");
   $('#table_cot').DataTable({
    ordering: false,
    // scrollY: 350
