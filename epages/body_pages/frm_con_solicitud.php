                ...
                <div class="panel-heading"><label id="csol" name="csol">SOLICITUD N° - </label></div>
                  ...
                  <form id="csoli" name="csoli" enctype="multipart/form-data" method="post">
                                ...
                                <select id="tser" name="tser" onchange="javascript:asignartec(this.value)" class="form-control" data-actions-box="true" style="width:100%;background:white;border:#367fa9 1px solid" required>
                                  <option selected="true">Seleccione Técnico</option>
                                  <?php
                                ...
                                <select id="tservi" name="tservi" class="form-control" data-actions-box="true" style="width:70%;background:white;border:#367fa9 1px solid" disabled>
                                ...
                                <select id="uneg" name="uneg" class="form-control" data-actions-box="true" 
                                style="width:70%;background:white;border:#367fa9 1px solid" disabled>
                                ...
                                <div class="col-md-4 col-xs-4 col-lg-4" align="center">
                                  <label align="center">Sub-tipo de Servicio</label>
                                  <select name="stipo" id="stipo" class="form-control" style="width:70%;background:white;border:#367fa9 1px solid">
                                    ...
                                    <option value="3">Incomunicación</option>
                                    <option value="4">Mantenimiento</option>
                                  </select>
                                </div>
                                <!--  -->
                                <div class="col-md-12 col-xs-12" style="color:#"5"8ACFA">
                                ...
                                <div align="center" style="margin-top:">
                                    ...
                                    <input type="button" class="btn btn-primary btn-sm " name="volver" id="volver" onclick="javascript:volver_case2()" value="Volver">
                                </div>
                        </form>
