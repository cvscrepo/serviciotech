<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-pie-chart"></i> Falla</a></li>
         <li class="active">R. Falla</li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      ...
      <div class="col-lg-12 col-xs-12">
         <div id="gridtable" name="gridtable" class="col-md-8 col-xs-12">
            <!-- Main content -->
            <section class="content">
         ...
         <div id="gform" name='gform' class="col-md-4 col-xs-12">
            <div class="panel-group">
               <div class="panel panel-primary">
                  <div class="panel-heading" align="center"><b>Registro Falla</b></div>
                  <div class="form-box" >
